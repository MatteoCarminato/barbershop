<div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
        <li class="nav-item me-auto"><a class="navbar-brand"
                                        href="{{asset('/private/html/ltr/vertical-menu-template/index.html')}}"><span
                    class="brand-logo">
...
<div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span
                    class="menu-title text-truncate" data-i18n="Forma de Pagamento">Forma de Pagamento</span></a>
            <ul class="menu-content">
                <li><a class="d-flex align-items-center" href="{{route('formpayment.create')}}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Cadastrar">Cadastrar</span></a>
                </li>
                <li><a class="d-flex align-items-center" href="{{route('formpayment.index')}}"><i
        ...
        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span
                    class="menu-title text-truncate" data-i18n="Condição de Pagamento">Condição de Pagamento</span></a>
            <ul class="menu-content">
                <li><a class="d-flex align-items-center" href="{{route('conditionpayment.create')}}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Cadastrar">Cadastrar</span></a>
                </li>
                <li><a class="d-flex align-items-center" href="{{route('conditionpayment.index')}}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate"
                                                            data-i18n="Listar">Listar</span></a>
                </li>
            </ul>
        ...
        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span
                    class="menu-title text-truncate" data-i18n="Condição de Pagamento">CEP</span></a>
            <ul class="menu-content">
                <li><a class="d-flex align-items-center" href="{{route('country.create')}}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Cadastrar">Cadastrar País</span></a>
                </li>
                <li><a class="d-flex align-items-center" href="{{route('country.index')}}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate"
...
{{--        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span--}}
{{--                    class="menu-title text-truncate" data-i18n="Motorista">Motorista</span></a>--}}
{{--            <ul class="menu-content">--}}
...
{{--        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span--}}
{{--                    class="menu-title text-truncate" data-i18n="Clientes">Clientes</span></a>--}}
{{--            <ul class="menu-content">--}}
{{--                <li><a class="d-flex align-items-center" href="#"><i--}}
{{--                            data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Cadastrar">Cadastrar</span></a>--}}
{{--                </li>--}}
...
{{--        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span--}}
{{--                    class="menu-title text-truncate" data-i18n="Usuário">Usuário</span></a>--}}
{{--            <ul class="menu-content">--}}
{{--                <li><a class="d-flex align-items-center" href="#"><i--}}
{{--                            data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Cadastrar">Cadastrar</span></a>--}}
{{--                </li>--}}
...
{{--        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span--}}
{{--                    class="menu-title text-truncate" data-i18n="Categoria">Categoria</span></a>--}}
{{--            <ul class="menu-content">--}}
{{--                <li><a class="d-flex align-items-center" href="#"><i--}}
{{--                            data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Cadastrar">Cadastrar</span></a>--}}
{{--                </li>--}}
